...
function startGUI () {
    ...
    gui.add(config, 'DYE_RESOLUTION', { 'highest': 8149, 'even higher': 4096, 'higher': 2048, 'high': 1024, 'medium': 512, 'low': 256, 'very low': 128 }).name('Quality').onFinishChange(initFramebuffers);
